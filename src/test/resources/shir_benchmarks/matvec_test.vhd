...
architecture tb of testbench is
    ...
    -- Easier debugging
    signal   data_t     : unsigned(23 downto 0);
...
begin
    ...
    begin
        ...
        for i in 0 to 255 loop
            for j in 0 to 255 loop
                ...
                I0_data <= (std_logic_vector(to_unsigned((i + j) mod 16, 16)));
    ...
    begin
        ...
        for i in 0 to 255 loop
            ...
            I1_data <= (std_logic_vector(to_unsigned(i mod 16, 16)));
    ...
    out_check_0 : process
        variable i : integer;
        variable j : integer;
        variable expected : unsigned(23 downto 0);
    begin
        ready <= "ZZ";
        wait until test_0_start;
        ...
        for i in 0 to 255 loop
            ...
            expected := to_unsigned(0, 24);
            for j in 0 to 255 loop
                expected := expected + ((i + j) mod 16) * (j mod 16);
            end loop;
            ready <= "11";
