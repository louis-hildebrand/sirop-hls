...
module ShiftT(
  ...
  reg [31:0] _RAND_0;
  reg [7:0] _T_1; // @[ShiftT.scala 24:82]
  reg [31:0] _RAND_1;
  reg [7:0] _T_2; // @[ShiftT.scala 24:82]
  reg [31:0] _RAND_2;
  reg [7:0] _T_3; // @[ShiftT.scala 24:82]
  reg [31:0] _RAND_3;
  assign O_0 = _T_0; // @[ShiftT.scala 24:7]
  assign O_1 = _T_1; // @[ShiftT.scala 24:7]
  assign O_2 = _T_2; // @[ShiftT.scala 24:7]
  assign O_3 = _T_3; // @[ShiftT.scala 24:7]
`ifdef RANDOMIZE_GARBAGE_ASSIGN
`define RANDOMIZE
`endif
`ifdef RANDOMIZE_INVALID_ASSIGN
...
module ShiftTS(
  ...
  assign O_4 = I_0; // @[ShiftTS.scala 40:36]
  assign O_5 = I_1; // @[ShiftTS.scala 40:36]
  assign O_6 = I_2; // @[ShiftTS.scala 40:36]
  assign O_7 = I_3; // @[ShiftTS.scala 40:36]
  assign ShiftT_clock = clock;
  assign ShiftT_I_0 = I_4; // @[ShiftTS.scala 50:25]
  assign ShiftT_I_1 = I_5; // @[ShiftTS.scala 50:25]
  assign ShiftT_I_2 = I_6; // @[ShiftTS.scala 50:25]
  assign ShiftT_I_3 = I_7; // @[ShiftTS.scala 50:25]
endmodule
module ShiftT_2(
  input        clock,
  input  [7:0] I_0,
...
module Module_1(
  ...
  LogicalOr n169 ( // @[Top.scala 81:22]
