...
module RAM_ST(
  ...
  wire [2:0] _T_4 = {{1'd0}, _GEN_12}; // @[RAM_ST.scala 32:46]
  wire [63:0] _T_11 = ram__T_9_data;
...
initial begin
  ...
  `ifdef RANDOMIZE_REG_INIT
  _RAND_2 = {1{`RANDOM}};
  ram__T_9_addr_pipe_0 = _RAND_2[1:0];
  `endif // RANDOMIZE_REG_INIT
  `endif // RANDOMIZE
end // initial
`endif // SYNTHESIS
...
module Counter_T(
  ...
  reg [31:0] _RAND_0;
  wire  _T = counter_value == 32'he; // @[Counter.scala 61:49]
  wire [31:0] _T_3 = counter_value + 32'h2; // @[Counter.scala 63:70]
...
module Module_0(
  ...
  LogicalNot n114 ( // @[Top.scala 25:22]
  ...
  assign n112_I1 = 32'h8; // @[Top.scala 20:13]
...
module Module_1(
  ...
  LogicalNot n126 ( // @[Top.scala 57:22]
...
module Module_9(
  ...
  LogicalOr n619 ( // @[Top.scala 424:22]
...
module Top(
  ...
  MapT_22 n969 ( // @[Top.scala 1074:22]
    .clock(n969_clock),
    .reset(n969_reset),
