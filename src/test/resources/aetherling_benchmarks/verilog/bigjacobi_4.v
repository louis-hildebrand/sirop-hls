...
module RAM_ST(
  ...
  reg [31:0] ram [0:31]; // @[RAM_ST.scala 29:24]
  reg [31:0] _RAND_0;
  wire [31:0] ram__T_11_data; // @[RAM_ST.scala 29:24]
  wire [4:0] ram__T_11_addr; // @[RAM_ST.scala 29:24]
  wire [31:0] ram__T_5_data; // @[RAM_ST.scala 29:24]
  wire [4:0] ram__T_5_addr; // @[RAM_ST.scala 29:24]
  wire  ram__T_5_mask; // @[RAM_ST.scala 29:24]
  wire  ram__T_5_en; // @[RAM_ST.scala 29:24]
  reg  ram__T_11_en_pipe_0;
  reg [31:0] _RAND_1;
  reg [4:0] ram__T_11_addr_pipe_0;
  reg [31:0] _RAND_2;
  wire [4:0] _GEN_1 = 5'h1 == WADDR ? 5'h1 : 5'h0; // @[RAM_ST.scala 31:71]
  wire [4:0] _GEN_2 = 5'h2 == WADDR ? 5'h2 : _GEN_1; // @[RAM_ST.scala 31:71]
  wire [4:0] _GEN_3 = 5'h3 == WADDR ? 5'h3 : _GEN_2; // @[RAM_ST.scala 31:71]
  wire [4:0] _GEN_4 = 5'h4 == WADDR ? 5'h4 : _GEN_3; // @[RAM_ST.scala 31:71]
  wire [4:0] _GEN_5 = 5'h5 == WADDR ? 5'h5 : _GEN_4; // @[RAM_ST.scala 31:71]
  wire [4:0] _GEN_6 = 5'h6 == WADDR ? 5'h6 : _GEN_5; // @[RAM_ST.scala 31:71]
  wire [4:0] _GEN_7 = 5'h7 == WADDR ? 5'h7 : _GEN_6; // @[RAM_ST.scala 31:71]
  wire [4:0] _GEN_8 = 5'h8 == WADDR ? 5'h8 : _GEN_7; // @[RAM_ST.scala 31:71]
  wire [4:0] _GEN_9 = 5'h9 == WADDR ? 5'h9 : _GEN_8; // @[RAM_ST.scala 31:71]
  wire [4:0] _GEN_10 = 5'ha == WADDR ? 5'ha : _GEN_9; // @[RAM_ST.scala 31:71]
  wire [4:0] _GEN_11 = 5'hb == WADDR ? 5'hb : _GEN_10; // @[RAM_ST.scala 31:71]
  wire [4:0] _GEN_12 = 5'hc == WADDR ? 5'hc : _GEN_11; // @[RAM_ST.scala 31:71]
  wire [4:0] _GEN_13 = 5'hd == WADDR ? 5'hd : _GEN_12; // @[RAM_ST.scala 31:71]
  wire [4:0] _GEN_14 = 5'he == WADDR ? 5'he : _GEN_13; // @[RAM_ST.scala 31:71]
  wire [4:0] _GEN_15 = 5'hf == WADDR ? 5'hf : _GEN_14; // @[RAM_ST.scala 31:71]
  wire [4:0] _GEN_16 = 5'h10 == WADDR ? 5'h10 : _GEN_15; // @[RAM_ST.scala 31:71]
  wire [4:0] _GEN_17 = 5'h11 == WADDR ? 5'h11 : _GEN_16; // @[RAM_ST.scala 31:71]
  wire [4:0] _GEN_18 = 5'h12 == WADDR ? 5'h12 : _GEN_17; // @[RAM_ST.scala 31:71]
  wire [4:0] _GEN_19 = 5'h13 == WADDR ? 5'h13 : _GEN_18; // @[RAM_ST.scala 31:71]
  wire [4:0] _GEN_20 = 5'h14 == WADDR ? 5'h14 : _GEN_19; // @[RAM_ST.scala 31:71]
  wire [4:0] _GEN_21 = 5'h15 == WADDR ? 5'h15 : _GEN_20; // @[RAM_ST.scala 31:71]
  wire [4:0] _GEN_22 = 5'h16 == WADDR ? 5'h16 : _GEN_21; // @[RAM_ST.scala 31:71]
  wire [4:0] _GEN_23 = 5'h17 == WADDR ? 5'h17 : _GEN_22; // @[RAM_ST.scala 31:71]
  wire [4:0] _GEN_24 = 5'h18 == WADDR ? 5'h18 : _GEN_23; // @[RAM_ST.scala 31:71]
  wire [4:0] _GEN_25 = 5'h19 == WADDR ? 5'h19 : _GEN_24; // @[RAM_ST.scala 31:71]
  wire [4:0] _GEN_26 = 5'h1a == WADDR ? 5'h1a : _GEN_25; // @[RAM_ST.scala 31:71]
  wire [4:0] _GEN_27 = 5'h1b == WADDR ? 5'h1b : _GEN_26; // @[RAM_ST.scala 31:71]
  wire [4:0] _GEN_28 = 5'h1c == WADDR ? 5'h1c : _GEN_27; // @[RAM_ST.scala 31:71]
  wire [4:0] _GEN_29 = 5'h1d == WADDR ? 5'h1d : _GEN_28; // @[RAM_ST.scala 31:71]
  wire [4:0] _GEN_30 = 5'h1e == WADDR ? 5'h1e : _GEN_29; // @[RAM_ST.scala 31:71]
  wire [4:0] _GEN_31 = 5'h1f == WADDR ? 5'h1f : _GEN_30; // @[RAM_ST.scala 31:71]
  wire [5:0] _T = {{1'd0}, _GEN_31}; // @[RAM_ST.scala 31:71]
  wire [15:0] _T_2 = {WDATA_1,WDATA_0}; // @[RAM_ST.scala 31:115]
  wire [15:0] _T_3 = {WDATA_3,WDATA_2}; // @[RAM_ST.scala 31:115]
  wire [4:0] _GEN_38 = 5'h1 == RADDR ? 5'h1 : 5'h0; // @[RAM_ST.scala 32:46]
  wire [4:0] _GEN_39 = 5'h2 == RADDR ? 5'h2 : _GEN_38; // @[RAM_ST.scala 32:46]
  wire [4:0] _GEN_40 = 5'h3 == RADDR ? 5'h3 : _GEN_39; // @[RAM_ST.scala 32:46]
  wire [4:0] _GEN_41 = 5'h4 == RADDR ? 5'h4 : _GEN_40; // @[RAM_ST.scala 32:46]
  wire [4:0] _GEN_42 = 5'h5 == RADDR ? 5'h5 : _GEN_41; // @[RAM_ST.scala 32:46]
  wire [4:0] _GEN_43 = 5'h6 == RADDR ? 5'h6 : _GEN_42; // @[RAM_ST.scala 32:46]
  wire [4:0] _GEN_44 = 5'h7 == RADDR ? 5'h7 : _GEN_43; // @[RAM_ST.scala 32:46]
  wire [4:0] _GEN_45 = 5'h8 == RADDR ? 5'h8 : _GEN_44; // @[RAM_ST.scala 32:46]
  wire [4:0] _GEN_46 = 5'h9 == RADDR ? 5'h9 : _GEN_45; // @[RAM_ST.scala 32:46]
  wire [4:0] _GEN_47 = 5'ha == RADDR ? 5'ha : _GEN_46; // @[RAM_ST.scala 32:46]
  wire [4:0] _GEN_48 = 5'hb == RADDR ? 5'hb : _GEN_47; // @[RAM_ST.scala 32:46]
  wire [4:0] _GEN_49 = 5'hc == RADDR ? 5'hc : _GEN_48; // @[RAM_ST.scala 32:46]
  wire [4:0] _GEN_50 = 5'hd == RADDR ? 5'hd : _GEN_49; // @[RAM_ST.scala 32:46]
  wire [4:0] _GEN_51 = 5'he == RADDR ? 5'he : _GEN_50; // @[RAM_ST.scala 32:46]
  wire [4:0] _GEN_52 = 5'hf == RADDR ? 5'hf : _GEN_51; // @[RAM_ST.scala 32:46]
  wire [4:0] _GEN_53 = 5'h10 == RADDR ? 5'h10 : _GEN_52; // @[RAM_ST.scala 32:46]
  wire [4:0] _GEN_54 = 5'h11 == RADDR ? 5'h11 : _GEN_53; // @[RAM_ST.scala 32:46]
  wire [4:0] _GEN_55 = 5'h12 == RADDR ? 5'h12 : _GEN_54; // @[RAM_ST.scala 32:46]
  wire [4:0] _GEN_56 = 5'h13 == RADDR ? 5'h13 : _GEN_55; // @[RAM_ST.scala 32:46]
  wire [4:0] _GEN_57 = 5'h14 == RADDR ? 5'h14 : _GEN_56; // @[RAM_ST.scala 32:46]
  wire [4:0] _GEN_58 = 5'h15 == RADDR ? 5'h15 : _GEN_57; // @[RAM_ST.scala 32:46]
  wire [4:0] _GEN_59 = 5'h16 == RADDR ? 5'h16 : _GEN_58; // @[RAM_ST.scala 32:46]
  wire [4:0] _GEN_60 = 5'h17 == RADDR ? 5'h17 : _GEN_59; // @[RAM_ST.scala 32:46]
  wire [4:0] _GEN_61 = 5'h18 == RADDR ? 5'h18 : _GEN_60; // @[RAM_ST.scala 32:46]
  wire [4:0] _GEN_62 = 5'h19 == RADDR ? 5'h19 : _GEN_61; // @[RAM_ST.scala 32:46]
  wire [4:0] _GEN_63 = 5'h1a == RADDR ? 5'h1a : _GEN_62; // @[RAM_ST.scala 32:46]
  wire [4:0] _GEN_64 = 5'h1b == RADDR ? 5'h1b : _GEN_63; // @[RAM_ST.scala 32:46]
  wire [4:0] _GEN_65 = 5'h1c == RADDR ? 5'h1c : _GEN_64; // @[RAM_ST.scala 32:46]
  wire [4:0] _GEN_66 = 5'h1d == RADDR ? 5'h1d : _GEN_65; // @[RAM_ST.scala 32:46]
  wire [4:0] _GEN_67 = 5'h1e == RADDR ? 5'h1e : _GEN_66; // @[RAM_ST.scala 32:46]
  wire [4:0] _GEN_68 = 5'h1f == RADDR ? 5'h1f : _GEN_67; // @[RAM_ST.scala 32:46]
  wire [5:0] _T_6 = {{1'd0}, _GEN_68}; // @[RAM_ST.scala 32:46]
  wire [31:0] _T_13 = ram__T_11_data;
...
initial begin
  ...
  `ifdef RANDOMIZE_REG_INIT
  _RAND_2 = {1{`RANDOM}};
  ram__T_11_addr_pipe_0 = _RAND_2[4:0];
  `endif // RANDOMIZE_REG_INIT
  `endif // RANDOMIZE
end // initial
`endif // SYNTHESIS
  always @(posedge clock) begin
    ...
    if (read_elem_counter_valid) begin
      ram__T_11_addr_pipe_0 <= _T_6[4:0];
    end
  end
endmodule
module ShiftT(
  ...
  reg [31:0] _RAND_0;
  wire  _T_2 = value == 5'h1f; // @[Counter.scala 38:24]
  ...
  assign RAM_ST_RADDR = _T_2 ? 5'h0 : _T_4; // @[ShiftT.scala 46:76 ShiftT.scala 47:38]
