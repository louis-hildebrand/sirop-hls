...
module Map2S(
  ...
  assign valid_down = _T_4 & other_ops_5_valid_down; // @[Map2S.scala 26:14]
...
module ReduceS(
  ...
  assign AddNoValid_I_t0b = _T_7; // @[ReduceS.scala 43:18]
  ...
  assign AddNoValid_5_I_t1b = _T_5; // @[ReduceS.scala 43:18]
`ifdef RANDOMIZE_GARBAGE_ASSIGN
`define RANDOMIZE
`endif
`ifdef RANDOMIZE_INVALID_ASSIGN
