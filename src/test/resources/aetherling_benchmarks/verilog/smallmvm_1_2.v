...
module RAM_ST(
  ...
  wire  write_elem_counter_cur_valid; // @[RAM_ST.scala 20:34]
  wire  read_elem_counter_clock; // @[RAM_ST.scala 21:33]
  wire  read_elem_counter_reset; // @[RAM_ST.scala 21:33]
  wire  read_elem_counter_CE; // @[RAM_ST.scala 21:33]
  wire  read_elem_counter_valid; // @[RAM_ST.scala 21:33]
  wire  read_elem_counter_cur_valid; // @[RAM_ST.scala 21:33]
  reg [15:0] ram [0:1]; // @[RAM_ST.scala 29:24]
  reg [31:0] _RAND_0;
  ...
  reg [31:0] _RAND_2;
  wire [1:0] _T = {{1'd0}, write_elem_counter_cur_valid}; // @[RAM_ST.scala 31:71]
  wire [1:0] _T_4 = {{1'd0}, read_elem_counter_cur_valid}; // @[RAM_ST.scala 32:46]
...
module UpT(
  ...
  reg  value; // @[Counter.scala 29:33]
  reg [31:0] _RAND_0;
  wire  _T_3 = value + 1'h1; // @[Counter.scala 39:22]
  wire  _GEN_1 = valid_up & value; // @[Counter.scala 67:17]
  ...
  wire  _T_13 = _T_11 | value; // @[Upsample.scala 40:44]
...
module Module_0(
  ...
  wire [7:0] n13_I0; // @[Top.scala 18:21]
  wire [7:0] n13_I1; // @[Top.scala 18:21]
  wire [7:0] n13_O_t0b; // @[Top.scala 18:21]
  wire [7:0] n13_O_t1b; // @[Top.scala 18:21]
  ...
  wire [7:0] n14_I_t0b; // @[Top.scala 22:21]
  wire [7:0] n14_I_t1b; // @[Top.scala 22:21]
  wire [7:0] n14_O; // @[Top.scala 22:21]
...
module ReduceT(
  ...
  reg  value; // @[Counter.scala 29:33]
  reg [31:0] _RAND_1;
  wire  _T_5 = value + 1'h1; // @[Counter.scala 39:22]
  wire  _T_6 = ~value; // @[ReduceT.scala 34:60]
  ...
  reg [31:0] _RAND_6;
  wire  _T_14 = _T_12 | value; // @[ReduceT.scala 52:28]
...
module Module_1(
  ...
  wire [7:0] n21_I_0; // @[Top.scala 32:21]
  wire [7:0] n21_I_1; // @[Top.scala 32:21]
  wire [7:0] n21_O_0; // @[Top.scala 32:21]
  ...
  wire [7:0] n24_I_0; // @[Top.scala 35:21]
  wire [7:0] n24_O_0; // @[Top.scala 35:21]
  wire  n25_valid_up; // @[Top.scala 38:21]
  wire  n25_valid_down; // @[Top.scala 38:21]
  wire [7:0] n25_I_0; // @[Top.scala 38:21]
  wire [7:0] n25_O; // @[Top.scala 38:21]
...
module Top(
  ...
  wire [7:0] n1_I_0; // @[Top.scala 49:20]
  wire [7:0] n1_I_1; // @[Top.scala 49:20]
  wire [7:0] n1_O_0; // @[Top.scala 49:20]
  wire [7:0] n1_O_1; // @[Top.scala 49:20]
  ...
  wire [7:0] n6_I_0; // @[Top.scala 61:20]
  wire [7:0] n6_I_1; // @[Top.scala 61:20]
  ...
  wire [7:0] n7_I0_0; // @[Top.scala 64:20]
  wire [7:0] n7_I0_1; // @[Top.scala 64:20]
  wire [7:0] n7_I1_0; // @[Top.scala 64:20]
  wire [7:0] n7_I1_1; // @[Top.scala 64:20]
  wire [7:0] n7_O_0; // @[Top.scala 64:20]
  wire [7:0] n7_O_1; // @[Top.scala 64:20]
  wire  n15_valid_up; // @[Top.scala 68:21]
  wire  n15_valid_down; // @[Top.scala 68:21]
  wire [7:0] n15_I_0; // @[Top.scala 68:21]
  wire [7:0] n15_I_1; // @[Top.scala 68:21]
  wire [7:0] n15_O_0; // @[Top.scala 68:21]
  wire [7:0] n15_O_1; // @[Top.scala 68:21]
  ...
  wire [7:0] n26_I_0; // @[Top.scala 71:21]
  wire [7:0] n26_I_1; // @[Top.scala 71:21]
  wire [7:0] n26_O; // @[Top.scala 71:21]
  ...
  wire [7:0] n27_I; // @[Top.scala 74:21]
  wire [7:0] n27_O; // @[Top.scala 74:21]
  ...
  wire [7:0] n28_I; // @[Top.scala 77:21]
  wire [7:0] n28_O; // @[Top.scala 77:21]
  ...
  wire [7:0] n29_I; // @[Top.scala 80:21]
  wire [7:0] n29_O; // @[Top.scala 80:21]
