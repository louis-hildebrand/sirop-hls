...
module Map2S(
  ...
  assign valid_down = _T_3 & other_ops_4_valid_down; // @[Map2S.scala 26:14]
...
module ReduceS(
  ...
  reg [31:0] _RAND_6;
  reg  _T_7; // @[ReduceS.scala 47:32]
  reg [31:0] _RAND_7;
  reg  _T_8; // @[ReduceS.scala 47:24]
  reg [31:0] _RAND_8;
  ...
  assign valid_down = _T_8; // @[ReduceS.scala 47:14]
  ...
  assign AddNoValid_4_I_t0b = _T_3; // @[ReduceS.scala 43:18]
  assign AddNoValid_4_I_t1b = _T_5; // @[ReduceS.scala 43:18]
`ifdef RANDOMIZE_GARBAGE_ASSIGN
`define RANDOMIZE
`endif
`ifdef RANDOMIZE_INVALID_ASSIGN
...
module ReduceT(
  ...
  reg [31:0] _RAND_1;
  wire  _T_3 = value == 8'h8b; // @[Counter.scala 38:24]
