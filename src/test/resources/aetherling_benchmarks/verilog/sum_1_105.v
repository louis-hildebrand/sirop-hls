...
module ReduceS(
  ...
  wire [7:0] AddNoValid_6_I_t0b; // @[ReduceS.scala 20:43]
  wire [7:0] AddNoValid_6_I_t1b; // @[ReduceS.scala 20:43]
  wire [7:0] AddNoValid_6_O; // @[ReduceS.scala 20:43]
  ...
  reg [31:0] _RAND_7;
  reg [7:0] _T_8; // @[ReduceS.scala 43:46]
  reg [31:0] _RAND_8;
  ...
  assign AddNoValid_I_t0b = _T_5; // @[ReduceS.scala 43:18]
...
module Top(
  ...
  wire [7:0] n1_I_7; // @[Top.scala 17:20]
  ...
  wire [7:0] n1_O_7; // @[Top.scala 17:20]
  ...
  wire [7:0] n6_I_7; // @[Top.scala 20:20]
  ...
  assign n1_I_7 = I_7; // @[Top.scala 18:10]
  ...
  assign n6_I_7 = n1_O_7; // @[Top.scala 21:10]
