...
module RAM_ST(
  ...
  wire [6:0] write_elem_counter_cur_valid; // @[RAM_ST.scala 20:34]
  wire  read_elem_counter_clock; // @[RAM_ST.scala 21:33]
  wire  read_elem_counter_reset; // @[RAM_ST.scala 21:33]
  wire  read_elem_counter_CE; // @[RAM_ST.scala 21:33]
  wire  read_elem_counter_valid; // @[RAM_ST.scala 21:33]
  wire [6:0] read_elem_counter_cur_valid; // @[RAM_ST.scala 21:33]
  reg [31:0] ram [0:127]; // @[RAM_ST.scala 29:24]
  reg [31:0] _RAND_0;
  wire [31:0] ram__T_9_data; // @[RAM_ST.scala 29:24]
  wire [6:0] ram__T_9_addr; // @[RAM_ST.scala 29:24]
  wire [31:0] ram__T_3_data; // @[RAM_ST.scala 29:24]
  wire [6:0] ram__T_3_addr; // @[RAM_ST.scala 29:24]
  wire  ram__T_3_mask; // @[RAM_ST.scala 29:24]
  wire  ram__T_3_en; // @[RAM_ST.scala 29:24]
  reg  ram__T_9_en_pipe_0;
  reg [31:0] _RAND_1;
  reg [6:0] ram__T_9_addr_pipe_0;
  reg [31:0] _RAND_2;
  wire [7:0] _T = {{1'd0}, write_elem_counter_cur_valid}; // @[RAM_ST.scala 31:71]
  wire [7:0] _T_4 = {{1'd0}, read_elem_counter_cur_valid}; // @[RAM_ST.scala 32:46]
...
initial begin
  ...
  `ifdef RANDOMIZE_REG_INIT
  _RAND_2 = {1{`RANDOM}};
  ram__T_9_addr_pipe_0 = _RAND_2[6:0];
  `endif // RANDOMIZE_REG_INIT
  `endif // RANDOMIZE
end // initial
`endif // SYNTHESIS
...
module UpT(
  ...
  reg [6:0] value; // @[Counter.scala 29:33]
  reg [31:0] _RAND_0;
  wire  _T_1 = value == 7'h7f; // @[Counter.scala 38:24]
  wire [6:0] _T_3 = value + 7'h1; // @[Counter.scala 39:22]
...
module NestedCountersWithNumValid_2(
  ...
  reg [31:0] _RAND_0;
  wire [14:0] _T_4 = value + 15'h1; // @[Counter.scala 39:22]
...
module RAM_ST_1(
  ...
  wire  write_elem_counter_CE; // @[RAM_ST.scala 20:34]
  wire  write_elem_counter_valid; // @[RAM_ST.scala 20:34]
  wire [14:0] write_elem_counter_cur_valid; // @[RAM_ST.scala 20:34]
  wire  read_elem_counter_clock; // @[RAM_ST.scala 21:33]
  wire  read_elem_counter_reset; // @[RAM_ST.scala 21:33]
  wire  read_elem_counter_CE; // @[RAM_ST.scala 21:33]
  wire  read_elem_counter_valid; // @[RAM_ST.scala 21:33]
  wire [14:0] read_elem_counter_cur_valid; // @[RAM_ST.scala 21:33]
  reg [31:0] ram [0:32767]; // @[RAM_ST.scala 29:24]
  reg [31:0] _RAND_0;
  wire [31:0] ram__T_9_data; // @[RAM_ST.scala 29:24]
  wire [14:0] ram__T_9_addr; // @[RAM_ST.scala 29:24]
  wire [31:0] ram__T_3_data; // @[RAM_ST.scala 29:24]
  wire [14:0] ram__T_3_addr; // @[RAM_ST.scala 29:24]
  wire  ram__T_3_mask; // @[RAM_ST.scala 29:24]
  wire  ram__T_3_en; // @[RAM_ST.scala 29:24]
  reg  ram__T_9_en_pipe_0;
  reg [31:0] _RAND_1;
  reg [14:0] ram__T_9_addr_pipe_0;
  reg [31:0] _RAND_2;
  wire [15:0] _T = {{1'd0}, write_elem_counter_cur_valid}; // @[RAM_ST.scala 31:71]
  wire [15:0] _T_4 = {{1'd0}, read_elem_counter_cur_valid}; // @[RAM_ST.scala 32:46]
  wire [31:0] _T_11 = ram__T_9_data;
...
initial begin
  ...
  `ifdef RANDOMIZE_REG_INIT
  _RAND_2 = {1{`RANDOM}};
  ram__T_9_addr_pipe_0 = _RAND_2[14:0];
  `endif // RANDOMIZE_REG_INIT
  `endif // RANDOMIZE
end // initial
`endif // SYNTHESIS
  always @(posedge clock) begin
    ...
    ram__T_9_en_pipe_0 <= read_elem_counter_valid;
    if (read_elem_counter_valid) begin
      ram__T_9_addr_pipe_0 <= _T_4[14:0];
    end
  end
endmodule
module UpT_1(
  ...
  reg [14:0] value; // @[Counter.scala 29:33]
  reg [31:0] _RAND_0;
  wire  _T_1 = value == 15'h7fff; // @[Counter.scala 38:24]
  wire [14:0] _T_3 = value + 15'h1; // @[Counter.scala 39:22]
  wire  _GEN_1 = valid_up & _T_1; // @[Counter.scala 67:17]
  reg [7:0] value_1; // @[Counter.scala 29:33]
  reg [31:0] _RAND_1;
  wire [7:0] _T_9 = value_1 + 8'h1; // @[Counter.scala 39:22]
...
module ReduceT(
  ...
  reg [6:0] value; // @[Counter.scala 29:33]
  reg [31:0] _RAND_1;
  wire  _T_3 = value == 7'h7f; // @[Counter.scala 38:24]
