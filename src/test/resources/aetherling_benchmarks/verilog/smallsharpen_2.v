...
module RAM_ST(
  ...
  reg [31:0] _RAND_2;
  wire [1:0] _T = {{1'd0}, WADDR}; // @[RAM_ST.scala 31:71]
  wire [1:0] _T_4 = {{1'd0}, RADDR}; // @[RAM_ST.scala 32:46]
...
module ShiftT(
  ...
  assign RAM_ST_RADDR = value ? 1'h0 : _T_4; // @[ShiftT.scala 46:76 ShiftT.scala 47:38]
