...
module ReduceS(
  ...
  assign AddNoValid_4_I_t1b = _T_7; // @[ReduceS.scala 43:18]
  assign AddNoValid_5_I_t0b = AddNoValid_6_O; // @[ReduceS.scala 31:18]
  assign AddNoValid_5_I_t1b = _T_2; // @[ReduceS.scala 43:18]
  assign AddNoValid_6_I_t0b = _T_8; // @[ReduceS.scala 43:18]
  assign AddNoValid_6_I_t1b = _T_4; // @[ReduceS.scala 43:18]
`ifdef RANDOMIZE_GARBAGE_ASSIGN
`define RANDOMIZE
`endif
`ifdef RANDOMIZE_INVALID_ASSIGN
