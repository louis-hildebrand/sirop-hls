...
module NestedCountersWithNumValid_2(
  ...
  reg [31:0] _RAND_0;
  wire [13:0] _T_4 = value + 14'h1; // @[Counter.scala 39:22]
...
module RAM_ST_1(
  ...
  wire  write_elem_counter_CE; // @[RAM_ST.scala 20:34]
  wire  write_elem_counter_valid; // @[RAM_ST.scala 20:34]
  wire [13:0] write_elem_counter_cur_valid; // @[RAM_ST.scala 20:34]
  wire  read_elem_counter_clock; // @[RAM_ST.scala 21:33]
  wire  read_elem_counter_reset; // @[RAM_ST.scala 21:33]
  wire  read_elem_counter_CE; // @[RAM_ST.scala 21:33]
  wire  read_elem_counter_valid; // @[RAM_ST.scala 21:33]
  wire [13:0] read_elem_counter_cur_valid; // @[RAM_ST.scala 21:33]
  reg [63:0] ram [0:16383]; // @[RAM_ST.scala 29:24]
  reg [63:0] _RAND_0;
  wire [63:0] ram__T_11_data; // @[RAM_ST.scala 29:24]
  wire [13:0] ram__T_11_addr; // @[RAM_ST.scala 29:24]
  wire [63:0] ram__T_5_data; // @[RAM_ST.scala 29:24]
  wire [13:0] ram__T_5_addr; // @[RAM_ST.scala 29:24]
  wire  ram__T_5_mask; // @[RAM_ST.scala 29:24]
  wire  ram__T_5_en; // @[RAM_ST.scala 29:24]
  reg  ram__T_11_en_pipe_0;
  reg [31:0] _RAND_1;
  reg [13:0] ram__T_11_addr_pipe_0;
  reg [31:0] _RAND_2;
  wire [14:0] _T = {{1'd0}, write_elem_counter_cur_valid}; // @[RAM_ST.scala 31:71]
  wire [31:0] _T_2 = {WDATA_1,WDATA_0}; // @[RAM_ST.scala 31:115]
  wire [31:0] _T_3 = {WDATA_3,WDATA_2}; // @[RAM_ST.scala 31:115]
  wire [14:0] _T_6 = {{1'd0}, read_elem_counter_cur_valid}; // @[RAM_ST.scala 32:46]
  wire [63:0] _T_13 = ram__T_11_data;
...
initial begin
  ...
  `ifdef RANDOMIZE_REG_INIT
  _RAND_2 = {1{`RANDOM}};
  ram__T_11_addr_pipe_0 = _RAND_2[13:0];
  `endif // RANDOMIZE_REG_INIT
  `endif // RANDOMIZE
end // initial
`endif // SYNTHESIS
  always @(posedge clock) begin
    ...
    ram__T_11_en_pipe_0 <= read_elem_counter_valid;
    if (read_elem_counter_valid) begin
      ram__T_11_addr_pipe_0 <= _T_6[13:0];
    end
  end
endmodule
module UpT_1(
  ...
  reg [13:0] value; // @[Counter.scala 29:33]
  reg [31:0] _RAND_0;
  wire  _T_1 = value == 14'h3fff; // @[Counter.scala 38:24]
  wire [13:0] _T_3 = value + 14'h1; // @[Counter.scala 39:22]
  wire  _GEN_1 = valid_up & _T_1; // @[Counter.scala 67:17]
  reg [7:0] value_1; // @[Counter.scala 29:33]
  reg [31:0] _RAND_1;
  wire [7:0] _T_9 = value_1 + 8'h1; // @[Counter.scala 39:22]
