...
module RAM_ST(
  ...
  reg [63:0] ram [0:15]; // @[RAM_ST.scala 29:24]
  reg [63:0] _RAND_0;
  wire [63:0] ram__T_15_data; // @[RAM_ST.scala 29:24]
  wire [3:0] ram__T_15_addr; // @[RAM_ST.scala 29:24]
  wire [63:0] ram__T_9_data; // @[RAM_ST.scala 29:24]
  wire [3:0] ram__T_9_addr; // @[RAM_ST.scala 29:24]
  wire  ram__T_9_mask; // @[RAM_ST.scala 29:24]
  wire  ram__T_9_en; // @[RAM_ST.scala 29:24]
  reg  ram__T_15_en_pipe_0;
  reg [31:0] _RAND_1;
  reg [3:0] ram__T_15_addr_pipe_0;
  reg [31:0] _RAND_2;
  wire [3:0] _GEN_1 = 4'h1 == WADDR ? 4'h1 : 4'h0; // @[RAM_ST.scala 31:71]
  wire [3:0] _GEN_2 = 4'h2 == WADDR ? 4'h2 : _GEN_1; // @[RAM_ST.scala 31:71]
  wire [3:0] _GEN_3 = 4'h3 == WADDR ? 4'h3 : _GEN_2; // @[RAM_ST.scala 31:71]
  wire [3:0] _GEN_4 = 4'h4 == WADDR ? 4'h4 : _GEN_3; // @[RAM_ST.scala 31:71]
  wire [3:0] _GEN_5 = 4'h5 == WADDR ? 4'h5 : _GEN_4; // @[RAM_ST.scala 31:71]
  wire [3:0] _GEN_6 = 4'h6 == WADDR ? 4'h6 : _GEN_5; // @[RAM_ST.scala 31:71]
  wire [3:0] _GEN_7 = 4'h7 == WADDR ? 4'h7 : _GEN_6; // @[RAM_ST.scala 31:71]
  wire [3:0] _GEN_8 = 4'h8 == WADDR ? 4'h8 : _GEN_7; // @[RAM_ST.scala 31:71]
  wire [3:0] _GEN_9 = 4'h9 == WADDR ? 4'h9 : _GEN_8; // @[RAM_ST.scala 31:71]
  wire [3:0] _GEN_10 = 4'ha == WADDR ? 4'ha : _GEN_9; // @[RAM_ST.scala 31:71]
  wire [3:0] _GEN_11 = 4'hb == WADDR ? 4'hb : _GEN_10; // @[RAM_ST.scala 31:71]
  wire [3:0] _GEN_12 = 4'hc == WADDR ? 4'hc : _GEN_11; // @[RAM_ST.scala 31:71]
  wire [3:0] _GEN_13 = 4'hd == WADDR ? 4'hd : _GEN_12; // @[RAM_ST.scala 31:71]
  wire [3:0] _GEN_14 = 4'he == WADDR ? 4'he : _GEN_13; // @[RAM_ST.scala 31:71]
  wire [3:0] _GEN_15 = 4'hf == WADDR ? 4'hf : _GEN_14; // @[RAM_ST.scala 31:71]
  wire [4:0] _T = {{1'd0}, _GEN_15}; // @[RAM_ST.scala 31:71]
  wire [31:0] _T_4 = {WDATA_3,WDATA_2,WDATA_1,WDATA_0}; // @[RAM_ST.scala 31:115]
  wire [31:0] _T_7 = {WDATA_7,WDATA_6,WDATA_5,WDATA_4}; // @[RAM_ST.scala 31:115]
  wire [3:0] _GEN_22 = 4'h1 == RADDR ? 4'h1 : 4'h0; // @[RAM_ST.scala 32:46]
  wire [3:0] _GEN_23 = 4'h2 == RADDR ? 4'h2 : _GEN_22; // @[RAM_ST.scala 32:46]
  wire [3:0] _GEN_24 = 4'h3 == RADDR ? 4'h3 : _GEN_23; // @[RAM_ST.scala 32:46]
  wire [3:0] _GEN_25 = 4'h4 == RADDR ? 4'h4 : _GEN_24; // @[RAM_ST.scala 32:46]
  wire [3:0] _GEN_26 = 4'h5 == RADDR ? 4'h5 : _GEN_25; // @[RAM_ST.scala 32:46]
  wire [3:0] _GEN_27 = 4'h6 == RADDR ? 4'h6 : _GEN_26; // @[RAM_ST.scala 32:46]
  wire [3:0] _GEN_28 = 4'h7 == RADDR ? 4'h7 : _GEN_27; // @[RAM_ST.scala 32:46]
  wire [3:0] _GEN_29 = 4'h8 == RADDR ? 4'h8 : _GEN_28; // @[RAM_ST.scala 32:46]
  wire [3:0] _GEN_30 = 4'h9 == RADDR ? 4'h9 : _GEN_29; // @[RAM_ST.scala 32:46]
  wire [3:0] _GEN_31 = 4'ha == RADDR ? 4'ha : _GEN_30; // @[RAM_ST.scala 32:46]
  wire [3:0] _GEN_32 = 4'hb == RADDR ? 4'hb : _GEN_31; // @[RAM_ST.scala 32:46]
  wire [3:0] _GEN_33 = 4'hc == RADDR ? 4'hc : _GEN_32; // @[RAM_ST.scala 32:46]
  wire [3:0] _GEN_34 = 4'hd == RADDR ? 4'hd : _GEN_33; // @[RAM_ST.scala 32:46]
  wire [3:0] _GEN_35 = 4'he == RADDR ? 4'he : _GEN_34; // @[RAM_ST.scala 32:46]
  wire [3:0] _GEN_36 = 4'hf == RADDR ? 4'hf : _GEN_35; // @[RAM_ST.scala 32:46]
  wire [4:0] _T_10 = {{1'd0}, _GEN_36}; // @[RAM_ST.scala 32:46]
  wire [63:0] _T_17 = ram__T_15_data;
...
initial begin
  ...
  `ifdef RANDOMIZE_REG_INIT
  _RAND_2 = {1{`RANDOM}};
  ram__T_15_addr_pipe_0 = _RAND_2[3:0];
  `endif // RANDOMIZE_REG_INIT
  `endif // RANDOMIZE
end // initial
`endif // SYNTHESIS
  always @(posedge clock) begin
    ...
    if (read_elem_counter_valid) begin
      ram__T_15_addr_pipe_0 <= _T_10[3:0];
    end
  end
endmodule
module ShiftT(
  ...
  assign RAM_ST_RADDR = _T_2 ? 4'h0 : _T_4; // @[ShiftT.scala 46:76 ShiftT.scala 47:38]
