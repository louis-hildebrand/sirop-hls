...
module FIFO_1(
  ...
  reg [31:0] _RAND_0;
  wire [7:0] _T_0__T_15_data; // @[FIFO.scala 23:33]
  ...
  `else
  assign _T_0__T_15_data = _T_0__T_15_addr >= 3'h7 ? _RAND_1[7:0] : _T_0[_T_0__T_15_addr]; // @[FIFO.scala 23:33]
...
module Module_1(
  ...
  LogicalOr n174 ( // @[Top.scala 87:22]
