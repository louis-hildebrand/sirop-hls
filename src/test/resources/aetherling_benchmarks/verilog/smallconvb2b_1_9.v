...
module LShift(
  ...
  wire [262:0] _GEN_0 = {{255'd0}, I_t0b}; // @[Arithmetic.scala 431:25]
  wire [262:0] _T = _GEN_0 << I_t1b; // @[Arithmetic.scala 431:25]
...
module NestedCounters_77(
  ...
  wire  _T_2 = value == 2'h2; // @[Counter.scala 38:24]
  wire [1:0] _T_4 = value + 2'h1; // @[Counter.scala 39:22]
  wire  _T_7 = value < 2'h2; // @[NestedCounters.scala 48:35]
  NestedCounters NestedCounters ( // @[NestedCounters.scala 43:31]
    .CE(NestedCounters_CE),
    .valid(NestedCounters_valid)
  );
...
module NestedCountersWithNumValid_30(
  ...
  reg [31:0] _RAND_0;
  wire  _T_4 = value + 1'h1; // @[Counter.scala 39:22]
...
module Serialize_6(
  ...
  wire  _T_2 = value == 2'h2; // @[Counter.scala 38:24]
  wire [1:0] _T_4 = value + 2'h1; // @[Counter.scala 39:22]
  wire  _T_6 = value == 2'h0; // @[Serialize.scala 28:33]
  wire  _GEN_3 = elem_counter_cur_valid; // @[Serialize.scala 28:54]
  wire  _T_12 = elem_counter_cur_valid + 1'h1; // @[Serialize.scala 34:60]
  wire  _T_17 = 2'h1 == value; // @[Mux.scala 68:19]
  wire [7:0] mux_input_wire_1 = _T_5__T_16_data; // @[Serialize.scala 20:28 Serialize.scala 35:29]
  wire  _T_19 = 2'h0 == value; // @[Mux.scala 68:19]
...
module Module_1(
  ...
  wire  _T_2 = value == 4'h8; // @[Counter.scala 38:24]
  wire [3:0] _T_4 = value + 4'h1; // @[Counter.scala 39:22]
  wire [7:0] _GEN_4 = 4'h1 == value ? 8'h2 : 8'h0; // @[Const.scala 25:72]
  wire [7:0] _GEN_5 = 4'h2 == value ? 8'h1 : _GEN_4; // @[Const.scala 25:72]
  wire [7:0] _GEN_6 = 4'h3 == value ? 8'h1 : _GEN_5; // @[Const.scala 25:72]
  wire [7:0] _GEN_7 = 4'h4 == value ? 8'h0 : _GEN_6; // @[Const.scala 25:72]
  wire [7:0] _GEN_8 = 4'h5 == value ? 8'h0 : _GEN_7; // @[Const.scala 25:72]
  wire [7:0] _GEN_9 = 4'h6 == value ? 8'h0 : _GEN_8; // @[Const.scala 25:72]
  wire [7:0] _GEN_10 = 4'h7 == value ? 8'h0 : _GEN_9; // @[Const.scala 25:72]
  reg [3:0] value_1; // @[Counter.scala 29:33]
  reg [31:0] _RAND_1;
  wire  _T_8 = value_1 == 4'h8; // @[Counter.scala 38:24]
  wire [3:0] _T_10 = value_1 + 4'h1; // @[Counter.scala 39:22]
  wire [7:0] _GEN_16 = 4'h1 == value_1 ? 8'h0 : 8'h3; // @[Const.scala 25:72]
  wire [7:0] _GEN_17 = 4'h2 == value_1 ? 8'h0 : _GEN_16; // @[Const.scala 25:72]
  wire [7:0] _GEN_18 = 4'h3 == value_1 ? 8'h0 : _GEN_17; // @[Const.scala 25:72]
  wire [7:0] _GEN_19 = 4'h4 == value_1 ? 8'h0 : _GEN_18; // @[Const.scala 25:72]
  wire [7:0] _GEN_20 = 4'h5 == value_1 ? 8'h0 : _GEN_19; // @[Const.scala 25:72]
  ...
  assign n189_I1 = 4'h8 == value ? 8'h0 : _GEN_10; // @[Top.scala 49:13]
  ...
  assign n213_I1 = 4'h8 == value_1 ? 8'h0 : _GEN_22; // @[Top.scala 63:13]
