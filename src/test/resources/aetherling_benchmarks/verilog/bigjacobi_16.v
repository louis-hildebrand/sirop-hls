...
module RAM_ST(
  ...
  wire [63:0] _T_8 = {WDATA_7,WDATA_6,WDATA_5,WDATA_4,WDATA_3,WDATA_2,WDATA_1,WDATA_0}; // @[RAM_ST.scala 31:115]
  wire [63:0] _T_15 = {WDATA_15,WDATA_14,WDATA_13,WDATA_12,WDATA_11,WDATA_10,WDATA_9,WDATA_8}; // @[RAM_ST.scala 31:115]
  ...
  wire [3:0] _T_18 = {{1'd0}, _GEN_20}; // @[RAM_ST.scala 32:46]
  wire [127:0] _T_25 = ram__T_23_data;
...
initial begin
  ...
  `ifdef RANDOMIZE_REG_INIT
  _RAND_2 = {1{`RANDOM}};
  ram__T_23_addr_pipe_0 = _RAND_2[2:0];
  `endif // RANDOMIZE_REG_INIT
  `endif // RANDOMIZE
end // initial
`endif // SYNTHESIS
  always @(posedge clock) begin
    ...
    if (read_elem_counter_valid) begin
      ram__T_23_addr_pipe_0 <= _T_18[2:0];
    end
  end
endmodule
module ShiftT(
