...
module RAM_ST(
  ...
  reg [15:0] ram [0:63]; // @[RAM_ST.scala 29:24]
  reg [31:0] _RAND_0;
  wire [15:0] ram__T_9_data; // @[RAM_ST.scala 29:24]
  wire [5:0] ram__T_9_addr; // @[RAM_ST.scala 29:24]
  wire [15:0] ram__T_3_data; // @[RAM_ST.scala 29:24]
  wire [5:0] ram__T_3_addr; // @[RAM_ST.scala 29:24]
  wire  ram__T_3_mask; // @[RAM_ST.scala 29:24]
  wire  ram__T_3_en; // @[RAM_ST.scala 29:24]
  reg  ram__T_9_en_pipe_0;
  reg [31:0] _RAND_1;
  reg [5:0] ram__T_9_addr_pipe_0;
  reg [31:0] _RAND_2;
  wire [5:0] _GEN_1 = 6'h1 == WADDR ? 6'h1 : 6'h0; // @[RAM_ST.scala 31:71]
  wire [5:0] _GEN_2 = 6'h2 == WADDR ? 6'h2 : _GEN_1; // @[RAM_ST.scala 31:71]
  wire [5:0] _GEN_3 = 6'h3 == WADDR ? 6'h3 : _GEN_2; // @[RAM_ST.scala 31:71]
  wire [5:0] _GEN_4 = 6'h4 == WADDR ? 6'h4 : _GEN_3; // @[RAM_ST.scala 31:71]
  wire [5:0] _GEN_5 = 6'h5 == WADDR ? 6'h5 : _GEN_4; // @[RAM_ST.scala 31:71]
  wire [5:0] _GEN_6 = 6'h6 == WADDR ? 6'h6 : _GEN_5; // @[RAM_ST.scala 31:71]
  wire [5:0] _GEN_7 = 6'h7 == WADDR ? 6'h7 : _GEN_6; // @[RAM_ST.scala 31:71]
  wire [5:0] _GEN_8 = 6'h8 == WADDR ? 6'h8 : _GEN_7; // @[RAM_ST.scala 31:71]
  wire [5:0] _GEN_9 = 6'h9 == WADDR ? 6'h9 : _GEN_8; // @[RAM_ST.scala 31:71]
  wire [5:0] _GEN_10 = 6'ha == WADDR ? 6'ha : _GEN_9; // @[RAM_ST.scala 31:71]
  wire [5:0] _GEN_11 = 6'hb == WADDR ? 6'hb : _GEN_10; // @[RAM_ST.scala 31:71]
  wire [5:0] _GEN_12 = 6'hc == WADDR ? 6'hc : _GEN_11; // @[RAM_ST.scala 31:71]
  wire [5:0] _GEN_13 = 6'hd == WADDR ? 6'hd : _GEN_12; // @[RAM_ST.scala 31:71]
  wire [5:0] _GEN_14 = 6'he == WADDR ? 6'he : _GEN_13; // @[RAM_ST.scala 31:71]
  wire [5:0] _GEN_15 = 6'hf == WADDR ? 6'hf : _GEN_14; // @[RAM_ST.scala 31:71]
  wire [5:0] _GEN_16 = 6'h10 == WADDR ? 6'h10 : _GEN_15; // @[RAM_ST.scala 31:71]
  wire [5:0] _GEN_17 = 6'h11 == WADDR ? 6'h11 : _GEN_16; // @[RAM_ST.scala 31:71]
  wire [5:0] _GEN_18 = 6'h12 == WADDR ? 6'h12 : _GEN_17; // @[RAM_ST.scala 31:71]
  wire [5:0] _GEN_19 = 6'h13 == WADDR ? 6'h13 : _GEN_18; // @[RAM_ST.scala 31:71]
  wire [5:0] _GEN_20 = 6'h14 == WADDR ? 6'h14 : _GEN_19; // @[RAM_ST.scala 31:71]
  wire [5:0] _GEN_21 = 6'h15 == WADDR ? 6'h15 : _GEN_20; // @[RAM_ST.scala 31:71]
  wire [5:0] _GEN_22 = 6'h16 == WADDR ? 6'h16 : _GEN_21; // @[RAM_ST.scala 31:71]
  wire [5:0] _GEN_23 = 6'h17 == WADDR ? 6'h17 : _GEN_22; // @[RAM_ST.scala 31:71]
  wire [5:0] _GEN_24 = 6'h18 == WADDR ? 6'h18 : _GEN_23; // @[RAM_ST.scala 31:71]
  wire [5:0] _GEN_25 = 6'h19 == WADDR ? 6'h19 : _GEN_24; // @[RAM_ST.scala 31:71]
  wire [5:0] _GEN_26 = 6'h1a == WADDR ? 6'h1a : _GEN_25; // @[RAM_ST.scala 31:71]
  wire [5:0] _GEN_27 = 6'h1b == WADDR ? 6'h1b : _GEN_26; // @[RAM_ST.scala 31:71]
  wire [5:0] _GEN_28 = 6'h1c == WADDR ? 6'h1c : _GEN_27; // @[RAM_ST.scala 31:71]
  wire [5:0] _GEN_29 = 6'h1d == WADDR ? 6'h1d : _GEN_28; // @[RAM_ST.scala 31:71]
  wire [5:0] _GEN_30 = 6'h1e == WADDR ? 6'h1e : _GEN_29; // @[RAM_ST.scala 31:71]
  wire [5:0] _GEN_31 = 6'h1f == WADDR ? 6'h1f : _GEN_30; // @[RAM_ST.scala 31:71]
  wire [5:0] _GEN_32 = 6'h20 == WADDR ? 6'h20 : _GEN_31; // @[RAM_ST.scala 31:71]
  wire [5:0] _GEN_33 = 6'h21 == WADDR ? 6'h21 : _GEN_32; // @[RAM_ST.scala 31:71]
  wire [5:0] _GEN_34 = 6'h22 == WADDR ? 6'h22 : _GEN_33; // @[RAM_ST.scala 31:71]
  wire [5:0] _GEN_35 = 6'h23 == WADDR ? 6'h23 : _GEN_34; // @[RAM_ST.scala 31:71]
  wire [5:0] _GEN_36 = 6'h24 == WADDR ? 6'h24 : _GEN_35; // @[RAM_ST.scala 31:71]
  wire [5:0] _GEN_37 = 6'h25 == WADDR ? 6'h25 : _GEN_36; // @[RAM_ST.scala 31:71]
  wire [5:0] _GEN_38 = 6'h26 == WADDR ? 6'h26 : _GEN_37; // @[RAM_ST.scala 31:71]
  wire [5:0] _GEN_39 = 6'h27 == WADDR ? 6'h27 : _GEN_38; // @[RAM_ST.scala 31:71]
  wire [5:0] _GEN_40 = 6'h28 == WADDR ? 6'h28 : _GEN_39; // @[RAM_ST.scala 31:71]
  wire [5:0] _GEN_41 = 6'h29 == WADDR ? 6'h29 : _GEN_40; // @[RAM_ST.scala 31:71]
  wire [5:0] _GEN_42 = 6'h2a == WADDR ? 6'h2a : _GEN_41; // @[RAM_ST.scala 31:71]
  wire [5:0] _GEN_43 = 6'h2b == WADDR ? 6'h2b : _GEN_42; // @[RAM_ST.scala 31:71]
  wire [5:0] _GEN_44 = 6'h2c == WADDR ? 6'h2c : _GEN_43; // @[RAM_ST.scala 31:71]
  wire [5:0] _GEN_45 = 6'h2d == WADDR ? 6'h2d : _GEN_44; // @[RAM_ST.scala 31:71]
  wire [5:0] _GEN_46 = 6'h2e == WADDR ? 6'h2e : _GEN_45; // @[RAM_ST.scala 31:71]
  wire [5:0] _GEN_47 = 6'h2f == WADDR ? 6'h2f : _GEN_46; // @[RAM_ST.scala 31:71]
  wire [5:0] _GEN_48 = 6'h30 == WADDR ? 6'h30 : _GEN_47; // @[RAM_ST.scala 31:71]
  wire [5:0] _GEN_49 = 6'h31 == WADDR ? 6'h31 : _GEN_48; // @[RAM_ST.scala 31:71]
  wire [5:0] _GEN_50 = 6'h32 == WADDR ? 6'h32 : _GEN_49; // @[RAM_ST.scala 31:71]
  wire [5:0] _GEN_51 = 6'h33 == WADDR ? 6'h33 : _GEN_50; // @[RAM_ST.scala 31:71]
  wire [5:0] _GEN_52 = 6'h34 == WADDR ? 6'h34 : _GEN_51; // @[RAM_ST.scala 31:71]
  wire [5:0] _GEN_53 = 6'h35 == WADDR ? 6'h35 : _GEN_52; // @[RAM_ST.scala 31:71]
  wire [5:0] _GEN_54 = 6'h36 == WADDR ? 6'h36 : _GEN_53; // @[RAM_ST.scala 31:71]
  wire [5:0] _GEN_55 = 6'h37 == WADDR ? 6'h37 : _GEN_54; // @[RAM_ST.scala 31:71]
  wire [5:0] _GEN_56 = 6'h38 == WADDR ? 6'h38 : _GEN_55; // @[RAM_ST.scala 31:71]
  wire [5:0] _GEN_57 = 6'h39 == WADDR ? 6'h39 : _GEN_56; // @[RAM_ST.scala 31:71]
  wire [5:0] _GEN_58 = 6'h3a == WADDR ? 6'h3a : _GEN_57; // @[RAM_ST.scala 31:71]
  wire [5:0] _GEN_59 = 6'h3b == WADDR ? 6'h3b : _GEN_58; // @[RAM_ST.scala 31:71]
  wire [5:0] _GEN_60 = 6'h3c == WADDR ? 6'h3c : _GEN_59; // @[RAM_ST.scala 31:71]
  wire [5:0] _GEN_61 = 6'h3d == WADDR ? 6'h3d : _GEN_60; // @[RAM_ST.scala 31:71]
  wire [5:0] _GEN_62 = 6'h3e == WADDR ? 6'h3e : _GEN_61; // @[RAM_ST.scala 31:71]
  wire [5:0] _GEN_63 = 6'h3f == WADDR ? 6'h3f : _GEN_62; // @[RAM_ST.scala 31:71]
  wire [6:0] _T = {{1'd0}, _GEN_63}; // @[RAM_ST.scala 31:71]
  wire [5:0] _GEN_70 = 6'h1 == RADDR ? 6'h1 : 6'h0; // @[RAM_ST.scala 32:46]
  wire [5:0] _GEN_71 = 6'h2 == RADDR ? 6'h2 : _GEN_70; // @[RAM_ST.scala 32:46]
  wire [5:0] _GEN_72 = 6'h3 == RADDR ? 6'h3 : _GEN_71; // @[RAM_ST.scala 32:46]
  wire [5:0] _GEN_73 = 6'h4 == RADDR ? 6'h4 : _GEN_72; // @[RAM_ST.scala 32:46]
  wire [5:0] _GEN_74 = 6'h5 == RADDR ? 6'h5 : _GEN_73; // @[RAM_ST.scala 32:46]
  wire [5:0] _GEN_75 = 6'h6 == RADDR ? 6'h6 : _GEN_74; // @[RAM_ST.scala 32:46]
  wire [5:0] _GEN_76 = 6'h7 == RADDR ? 6'h7 : _GEN_75; // @[RAM_ST.scala 32:46]
  wire [5:0] _GEN_77 = 6'h8 == RADDR ? 6'h8 : _GEN_76; // @[RAM_ST.scala 32:46]
  wire [5:0] _GEN_78 = 6'h9 == RADDR ? 6'h9 : _GEN_77; // @[RAM_ST.scala 32:46]
  wire [5:0] _GEN_79 = 6'ha == RADDR ? 6'ha : _GEN_78; // @[RAM_ST.scala 32:46]
  wire [5:0] _GEN_80 = 6'hb == RADDR ? 6'hb : _GEN_79; // @[RAM_ST.scala 32:46]
  wire [5:0] _GEN_81 = 6'hc == RADDR ? 6'hc : _GEN_80; // @[RAM_ST.scala 32:46]
  wire [5:0] _GEN_82 = 6'hd == RADDR ? 6'hd : _GEN_81; // @[RAM_ST.scala 32:46]
  wire [5:0] _GEN_83 = 6'he == RADDR ? 6'he : _GEN_82; // @[RAM_ST.scala 32:46]
  wire [5:0] _GEN_84 = 6'hf == RADDR ? 6'hf : _GEN_83; // @[RAM_ST.scala 32:46]
  wire [5:0] _GEN_85 = 6'h10 == RADDR ? 6'h10 : _GEN_84; // @[RAM_ST.scala 32:46]
  wire [5:0] _GEN_86 = 6'h11 == RADDR ? 6'h11 : _GEN_85; // @[RAM_ST.scala 32:46]
  wire [5:0] _GEN_87 = 6'h12 == RADDR ? 6'h12 : _GEN_86; // @[RAM_ST.scala 32:46]
  wire [5:0] _GEN_88 = 6'h13 == RADDR ? 6'h13 : _GEN_87; // @[RAM_ST.scala 32:46]
  wire [5:0] _GEN_89 = 6'h14 == RADDR ? 6'h14 : _GEN_88; // @[RAM_ST.scala 32:46]
  wire [5:0] _GEN_90 = 6'h15 == RADDR ? 6'h15 : _GEN_89; // @[RAM_ST.scala 32:46]
  wire [5:0] _GEN_91 = 6'h16 == RADDR ? 6'h16 : _GEN_90; // @[RAM_ST.scala 32:46]
  wire [5:0] _GEN_92 = 6'h17 == RADDR ? 6'h17 : _GEN_91; // @[RAM_ST.scala 32:46]
  wire [5:0] _GEN_93 = 6'h18 == RADDR ? 6'h18 : _GEN_92; // @[RAM_ST.scala 32:46]
  wire [5:0] _GEN_94 = 6'h19 == RADDR ? 6'h19 : _GEN_93; // @[RAM_ST.scala 32:46]
  wire [5:0] _GEN_95 = 6'h1a == RADDR ? 6'h1a : _GEN_94; // @[RAM_ST.scala 32:46]
  wire [5:0] _GEN_96 = 6'h1b == RADDR ? 6'h1b : _GEN_95; // @[RAM_ST.scala 32:46]
  wire [5:0] _GEN_97 = 6'h1c == RADDR ? 6'h1c : _GEN_96; // @[RAM_ST.scala 32:46]
  wire [5:0] _GEN_98 = 6'h1d == RADDR ? 6'h1d : _GEN_97; // @[RAM_ST.scala 32:46]
  wire [5:0] _GEN_99 = 6'h1e == RADDR ? 6'h1e : _GEN_98; // @[RAM_ST.scala 32:46]
  wire [5:0] _GEN_100 = 6'h1f == RADDR ? 6'h1f : _GEN_99; // @[RAM_ST.scala 32:46]
  wire [5:0] _GEN_101 = 6'h20 == RADDR ? 6'h20 : _GEN_100; // @[RAM_ST.scala 32:46]
  wire [5:0] _GEN_102 = 6'h21 == RADDR ? 6'h21 : _GEN_101; // @[RAM_ST.scala 32:46]
  wire [5:0] _GEN_103 = 6'h22 == RADDR ? 6'h22 : _GEN_102; // @[RAM_ST.scala 32:46]
  wire [5:0] _GEN_104 = 6'h23 == RADDR ? 6'h23 : _GEN_103; // @[RAM_ST.scala 32:46]
  wire [5:0] _GEN_105 = 6'h24 == RADDR ? 6'h24 : _GEN_104; // @[RAM_ST.scala 32:46]
  wire [5:0] _GEN_106 = 6'h25 == RADDR ? 6'h25 : _GEN_105; // @[RAM_ST.scala 32:46]
  wire [5:0] _GEN_107 = 6'h26 == RADDR ? 6'h26 : _GEN_106; // @[RAM_ST.scala 32:46]
  wire [5:0] _GEN_108 = 6'h27 == RADDR ? 6'h27 : _GEN_107; // @[RAM_ST.scala 32:46]
  wire [5:0] _GEN_109 = 6'h28 == RADDR ? 6'h28 : _GEN_108; // @[RAM_ST.scala 32:46]
  wire [5:0] _GEN_110 = 6'h29 == RADDR ? 6'h29 : _GEN_109; // @[RAM_ST.scala 32:46]
  wire [5:0] _GEN_111 = 6'h2a == RADDR ? 6'h2a : _GEN_110; // @[RAM_ST.scala 32:46]
  wire [5:0] _GEN_112 = 6'h2b == RADDR ? 6'h2b : _GEN_111; // @[RAM_ST.scala 32:46]
  wire [5:0] _GEN_113 = 6'h2c == RADDR ? 6'h2c : _GEN_112; // @[RAM_ST.scala 32:46]
  wire [5:0] _GEN_114 = 6'h2d == RADDR ? 6'h2d : _GEN_113; // @[RAM_ST.scala 32:46]
  wire [5:0] _GEN_115 = 6'h2e == RADDR ? 6'h2e : _GEN_114; // @[RAM_ST.scala 32:46]
  wire [5:0] _GEN_116 = 6'h2f == RADDR ? 6'h2f : _GEN_115; // @[RAM_ST.scala 32:46]
  wire [5:0] _GEN_117 = 6'h30 == RADDR ? 6'h30 : _GEN_116; // @[RAM_ST.scala 32:46]
  wire [5:0] _GEN_118 = 6'h31 == RADDR ? 6'h31 : _GEN_117; // @[RAM_ST.scala 32:46]
  wire [5:0] _GEN_119 = 6'h32 == RADDR ? 6'h32 : _GEN_118; // @[RAM_ST.scala 32:46]
  wire [5:0] _GEN_120 = 6'h33 == RADDR ? 6'h33 : _GEN_119; // @[RAM_ST.scala 32:46]
  wire [5:0] _GEN_121 = 6'h34 == RADDR ? 6'h34 : _GEN_120; // @[RAM_ST.scala 32:46]
  wire [5:0] _GEN_122 = 6'h35 == RADDR ? 6'h35 : _GEN_121; // @[RAM_ST.scala 32:46]
  wire [5:0] _GEN_123 = 6'h36 == RADDR ? 6'h36 : _GEN_122; // @[RAM_ST.scala 32:46]
  wire [5:0] _GEN_124 = 6'h37 == RADDR ? 6'h37 : _GEN_123; // @[RAM_ST.scala 32:46]
  wire [5:0] _GEN_125 = 6'h38 == RADDR ? 6'h38 : _GEN_124; // @[RAM_ST.scala 32:46]
  wire [5:0] _GEN_126 = 6'h39 == RADDR ? 6'h39 : _GEN_125; // @[RAM_ST.scala 32:46]
  wire [5:0] _GEN_127 = 6'h3a == RADDR ? 6'h3a : _GEN_126; // @[RAM_ST.scala 32:46]
  wire [5:0] _GEN_128 = 6'h3b == RADDR ? 6'h3b : _GEN_127; // @[RAM_ST.scala 32:46]
  wire [5:0] _GEN_129 = 6'h3c == RADDR ? 6'h3c : _GEN_128; // @[RAM_ST.scala 32:46]
  wire [5:0] _GEN_130 = 6'h3d == RADDR ? 6'h3d : _GEN_129; // @[RAM_ST.scala 32:46]
  wire [5:0] _GEN_131 = 6'h3e == RADDR ? 6'h3e : _GEN_130; // @[RAM_ST.scala 32:46]
  wire [5:0] _GEN_132 = 6'h3f == RADDR ? 6'h3f : _GEN_131; // @[RAM_ST.scala 32:46]
  wire [6:0] _T_4 = {{1'd0}, _GEN_132}; // @[RAM_ST.scala 32:46]
  wire [15:0] _T_11 = ram__T_9_data;
...
initial begin
  ...
  `ifdef RANDOMIZE_REG_INIT
  _RAND_2 = {1{`RANDOM}};
  ram__T_9_addr_pipe_0 = _RAND_2[5:0];
  `endif // RANDOMIZE_REG_INIT
  `endif // RANDOMIZE
end // initial
`endif // SYNTHESIS
...
module ShiftT(
  ...
  reg [31:0] _RAND_0;
  wire  _T_2 = value == 6'h3f; // @[Counter.scala 38:24]
  ...
  assign RAM_ST_RADDR = _T_2 ? 6'h0 : _T_4; // @[ShiftT.scala 46:76 ShiftT.scala 47:38]
...
module InitialDelayCounter_1(
  ...
  reg [31:0] _RAND_0;
  wire  _T_1 = value < 4'h8; // @[InitialDelayCounter.scala 17:17]
...
module Map2S_10(
  ...
  assign fst_op_valid_up = valid_up; // @[Map2S.scala 16:19]
  assign fst_op_I0 = I0_0; // @[Map2S.scala 17:13]
  assign fst_op_I1 = 8'h2; // @[Map2S.scala 18:13]
endmodule
module Map2S_11(
  input        valid_up,
  output       valid_down,
