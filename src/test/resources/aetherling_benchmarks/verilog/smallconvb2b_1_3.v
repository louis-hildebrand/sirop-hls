...
module InitialDelayCounter_3(
  ...
  reg [31:0] _RAND_0;
  wire  _T_1 = value < 5'h12; // @[InitialDelayCounter.scala 17:17]
...
module Module_1(
  ...
  wire  _T_5 = value == 2'h2; // @[Counter.scala 38:24]
  wire [1:0] _T_7 = value + 2'h1; // @[Counter.scala 39:22]
  wire [7:0] _GEN_5 = 2'h1 == value ? 8'h2 : 8'h0; // @[Const.scala 25:72]
  wire [7:0] _GEN_6 = 2'h1 == value ? 8'h0 : 8'h1; // @[Const.scala 25:72]
  reg [1:0] value_1; // @[Counter.scala 29:33]
  reg [31:0] _RAND_1;
  wire  _T_11 = value_1 == 2'h2; // @[Counter.scala 38:24]
  wire [1:0] _T_13 = value_1 + 2'h1; // @[Counter.scala 39:22]
  wire [7:0] _GEN_13 = 2'h1 == value_1 ? 8'h0 : 8'h3; // @[Const.scala 25:72]
  ...
  assign n185_I1_0 = 2'h2 == value ? 8'h1 : _GEN_5; // @[Top.scala 55:13]
  assign n185_I1_1 = 2'h2 == value ? 8'h0 : _GEN_6; // @[Top.scala 55:13]
  ...
  assign n222_I1 = 2'h2 == value_1 ? 8'h0 : _GEN_13; // @[Top.scala 75:13]
