...
class StmSimplifierTests extends AnyFunSuite {
  ...
  test("StmBuild:IOCounterTrio1") {
        ...
        Map[Param, (Expr, Expr)](
          i -> (
            ...
            Mux(
              outCtr equ C(3)(u2),
              C(0)(U32),
              Sum(C(1)(U32), Mux(firstStep, C(0)(U32), i)())()
            )()
          ),
          firstStep -> (True, outCtr equ C(3)(u2)),
          outCtr -> (
            C(0)(u2),
            Mux(outCtr equ C(3)(u2), C(0)(u2), Sum(C(1)(u2), outCtr)())()
          )
        )
      )().tchk().lower()
    }
    ...
    val expected = {
      ...
      StmBuild(
        n,
        Tuple(firstStep, PadTo(outCtr, 32)(), outCtr)(),
        True,
        Map[Param, (Expr, Expr)](
          firstStep -> (True, outCtr equ C(3)(u2)),
          outCtr -> (
