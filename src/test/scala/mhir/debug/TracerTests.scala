  ...
  test("Stm2Vec") {
    ...
    val input =
      StmBuild(
        ...
        ReshapeData(i, I32)(),
        True,
        Map[Param, (Expr, Expr, Expr)](i -> (C(42)(U8), i + 1, Tuple()())),
        Map()
      )()
    ...
    val stm = {
      ...
      val scan = {
        ...
        StmBuild(
          ...
          Map[Param, (Expr, Expr, Expr)](
            sAcc -> (LetStm(1, s, count, zipped)(), True, Tuple()())
          )
        )().tchk()
      }
      scan
    ...
    val stm = {
      ...
      val scan = {
        ...
        StmBuild(
          ...
          Map[Param, (Expr, Expr, Expr)](
            sAcc -> (LetStm(0, s, count, zipped)(), True, Tuple()())
          )
        )().tchk()
      }
      scan
