...
"""
This script plots the resource usages for the Intel HLS compiler, SHIR, and
Sirop.
"""
...
def plot_resource_usages(
    ...
    alm_ax.bar(
        bottom=0,
        x=[x + BAR_WIDTH for i, x in enumerate(xs) if shir_alms[i] is not None],
    ...
    fig.savefig(c.IHC_RESOURCE_USAGE_PDF, bbox_inches="tight")
