...
object Program {
  ...
  def apply(name: String): Expr = {
    name.toLowerCase match {
      case "map"              => Parser.parse(getSource("map.sirop")).e
      case "shir:map"         => Parser.parse(getSource("map.sirop")).e
      case "dot"              => Parser.parse(getSource("dot.sirop")).e
      case "shir:dot"         => Parser.parse(getSource("dot.sirop")).e
      case "matvec"           => Parser.parse(getSource("matvec.sirop")).e
      case "shir:matvec"      => Parser.parse(getSource("matvec.sirop")).e
      case "smallmatmat"      => Parser.parse(getSource("small_matmat.sirop")).e
      case "shir:smallmatmat" => Parser.parse(getSource("small_matmat.sirop")).e
      case "matmat"           => Parser.parse(getSource("matmat.sirop")).e
      case "shir:matmat"      => Parser.parse(getSource("matmat.sirop")).e
      case "conv1d"           => Parser.parse(getSource("conv1d.sirop")).e
      case "shir:conv1d"      => Parser.parse(getSource("conv1d.sirop")).e
      case "conv2d"           => Parser.parse(getSource("conv2d.sirop")).e
      case "shir:conv2d"      => Parser.parse(getSource("conv2d.sirop")).e
      case "aetherling:conv2d"  => AetherlingConv2d
      case "convb2b"            => Parser.parse(getSource("convb2b.sirop")).e
      case "shir:convb2b"       => Parser.parse(getSource("convb2b.sirop")).e
      case "aetherling:convb2b" => AetherlingConvB2b
      case "jacobi"             => Parser.parse(getSource("jacobi.sirop")).e
      case "shir:jacobi"        => Parser.parse(getSource("jacobi.sirop")).e
      case "sharpen"            => Parser.parse(getSource("sharpen.sirop")).e
      case "shir:sharpen"       => Parser.parse(getSource("sharpen.sirop")).e
      case "aetherling:sharpen" => AetherlingSharpen
      case "sobel"              => Parser.parse(getSource("sobel.sirop")).e
      case "shir:sobel"         => Parser.parse(getSource("sobel.sirop")).e
      case "aetherling:sobel"   => AetherlingSobel
      case "camera"             => Parser.parse(getSource("camera.sirop")).e
      case "shir:camera"        => Parser.parse(getSource("camera.sirop")).e
